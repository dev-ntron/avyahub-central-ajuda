...
<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; padding-bottom: 1rem; border-bottom: 1px solid #e2e8f0;">
        ...
        <a href="/admin/articles" class="btn" style="background: #e2e8f0; color: #2d3748;">← Voltar</a>
    </div>
            ...
            <div>
                <div class="card" style="margin: 0;">
                    ...
                    <div style="border-top: 1px solid #e2e8f0; padding-top: 1rem; margin-top: 1rem;">
                        ...
                        <a href="/<?= $edit_article['slug'] ?>" class="btn" target="_blank" 
...
<div class="card" style="margin-bottom: 1.5rem;">
    <div style="display: flex; gap: 1rem; align-items: center;">
        ...
        <select onchange="window.location.href='/admin/articles?category=' + this.value" style="padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 6px;">
        ...
        <a href="/admin/articles" style="color: #e53e3e; text-decoration: none;">✕ Limpar filtros</a>
        <?php endif; ?>
    </div>
</div>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: flex; gap: 0.5rem;">
                            ...
                            <a href="/<?= $article['slug'] ?>" class="btn btn-sm" style="background: #38a169;" target="_blank">👁️</a>
                            <?php endif; ?>
                            <a href="/admin/articles?edit=<?= $article['id'] ?>" class="btn btn-sm">✏️</a>
...
<div class="card text-center" style="padding: 3rem;">
    ...
    <a href="/admin/articles?new=1" class="btn btn-success">Criar primeiro artigo</a>
</div>
<?php endif; ?>
